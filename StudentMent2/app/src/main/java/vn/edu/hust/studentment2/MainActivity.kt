package vn.edu.hust.studentment2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        studentList.add("Nguyễn Văn Thái - 001")
        studentList.add("Vũ Đình Dương - 002")
        studentList.add("Cồ Huy Khoa - 003")
        studentList.add("Dương Hưu Hiếu - 004")
        studentList.add("Lại Thanh Xuân - 005")
